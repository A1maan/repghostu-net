...
pretrained_weights_path = os.path.join(weights_dir, "best_eiuenet_isic2018.pth")
...
# 
# This script loads a pretrained EIU-Net model and evaluates it on the ISIC2018 test dataset to calculate:
...
plt.savefig(os.path.join(plots_dir, 'eiuenet_predictions_with_metrics_isic2018.png'), dpi=300, bbox_inches='tight')
plt.show()
