...
test_loader_2017 = DataLoader(test_dataset_2017, batch_size=1, shuffle=False, worker_init_fn=seed_worker)
...
if __name__ == "__main__":
    ...
    plt.savefig(os.path.join(plots_dir, 'mucmnet_predictions_grid_isic2017.png'))
    plt.show()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("MUCM-Net - Loss Curve (ISIC2017)")
    plt.legend()
    plt.tight_layout()
