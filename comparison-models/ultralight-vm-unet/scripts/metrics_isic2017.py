...
pretrained_weights_path = os.path.join(weights_dir, "best_ultralight_vm_unet_isic2017.pth")
...
plt.savefig(os.path.join(plots_dir, 'ultralight_vm_unet_predictions_with_metrics_isic2017.png'), dpi=300, bbox_inches='tight')
plt.show()
