...
train_loader_2017 = DataLoader(train_dataset_2017, batch_size=16, shuffle=True, drop_last=True, worker_init_fn=seed_worker)
test_loader_2017 = DataLoader(test_dataset_2017, batch_size=16, shuffle=False, worker_init_fn=seed_worker)
