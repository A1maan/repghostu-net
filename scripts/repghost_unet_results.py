...
# Results for RepGhostUNet on ISIC2017 and ISIC2018
results = {
    "ISIC2017": {
        "model": "RepGhostUNet",
        "dataset": "ISIC2017",
...
results_json_path = "repghost_unet_results.json"
with open(results_json_path, 'w') as f:
    json.dump(results, f, indent=4)
print(f"✅ Results saved to {results_json_path}")

# Create a detailed text report
report_path = "repghost_unet_results.txt"
with open(report_path, 'w') as f:
    f.write("=" * 60 + "\n")
    f.write("RepGhostUNet Evaluation Results\n")
    f.write("=" * 60 + "\n\n")
...
plt.suptitle('RepGhostUNet Evaluation Results Summary', fontsize=16, fontweight='bold', y=0.995)
plt.tight_layout()

# Save the comprehensive plot
plot_path = "repghost_unet_results_visualization.png"
...
plt.savefig('repghost_unet_results_table.png', dpi=300, bbox_inches='tight')
print(f"✅ Results table saved to repghost_unet_results_table.png")
plt.show()

# Print summary to console
print("\n" + "=" * 60)
print("REPGHOSTUNET EVALUATION RESULTS SUMMARY")
print("=" * 60)
print("\n📊 ISIC2017 Results:")
