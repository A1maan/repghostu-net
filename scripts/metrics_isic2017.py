...
pretrained_weights_path = os.path.join(project_root, "weights/best_repghost_unet_isic2017.pth")
...
plt.savefig(os.path.join(plots_dir, 'repghost_unet_predictions_with_metrics_isic2017.png'), dpi=300, bbox_inches='tight')
plt.show()
